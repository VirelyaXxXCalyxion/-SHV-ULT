...
(() => {
  ...
  function applySound(mode) {
    ...
    save(SOUND_KEY, m);
    if (m === "crackle") soundNote.textContent = "Crackle selected. (Add audio later if you want.)";
    if (m === "sleepToken") soundNote.textContent = "Sleep Token selected. (Link or embed later.)";
    if (m === "silence") soundNote.textContent = "Silence selected. Just breath and pulse.";
